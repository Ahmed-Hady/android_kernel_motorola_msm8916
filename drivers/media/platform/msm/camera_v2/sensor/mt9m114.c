...
#ifdef CONFIG_COMPAT
int32_t mt9m114_sensor_config32(struct msm_sensor_ctrl_t *s_ctrl,
	void __user *argp)
{
...
#ifdef CONFIG_COMPAT
	.sensor_config32 = mt9m114_sensor_config32,
#endif
